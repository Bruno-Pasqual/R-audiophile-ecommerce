...
const Navbar = () => {
  ...
  useEffect(() => {
    if (cartOpen) {
      refCartModal.current?.showModal();
    } else {
      refCartModal.current.close();
    }
  }, [cartOpen]);
    ...
    <nav className={styles.navbar}>
      <div className={styles.nav_center}>
        ...
        <div className={styles.links_container}>
          <NavLink to={'/R-audiophile-ecommerce/'}>HOME</NavLink>
          <NavLink to={'/R-audiophile-ecommerce/products/headphones'}>
            HEADPHONES
          </NavLink>
          <NavLink to={'/R-audiophile-ecommerce/products/speakers'}>
            SPEAKERS
          </NavLink>
          <NavLink to={'/R-audiophile-ecommerce/products/earphones'}>
            EARPHONES
          </NavLink>
        </div>
        <div className={styles.cart_container}>
          ...
          {cartProducts.length > 0 && (
            <div className={styles.number_itens}>{cartProducts.length}</div>
          )}
        </div>
      </div>
